...
const auditValidator = hasShape({
  ...
  durationMs: isNumber, errorCode: isOptional(isString), hostedToolWarning: isOptional(isString), requestMethod: isOptional(isString), requestPath: isOptional(isString),
