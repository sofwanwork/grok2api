...
$patches = @(
    ...
    @{ f = "backend/internal/pkg/tooltimeguard/tooltimeguard.go"; m = "ApplyTimeoutHint|EnlargeToolTimeout|isDevServerCommand|rewriteDevServerBackground|InterceptNoOpEdit"; d = "Patch 21: bash tool timeout guard + dev server background rewrite + no-op edit interceptor (A+B)"; regex = $true },
